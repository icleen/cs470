...
class MiniMaxAI2 extends GenericAI {
    ...
    public MiniMaxAI2(int _me, String host, int _maxDepth) {
        super(_me, host);
        maxDepth = _maxDepth;
    }
    ...
    private int move(int[][] state) {
        ...
        for(i = 0; i < validMoves.size(); i++) {
            val = minSearch(
                    updateBoard(state, validMoves.get(0)/8, validMoves.get(0)%8, me),
    ...
    // call: java MiniMaxAI2 [ipaddress] [player_number]
    ...
    public static void main(String args[]) {
        ...
        new MiniMaxAI2(Integer.parseInt(args[1]), args[0], maxdepth).play();
    }
